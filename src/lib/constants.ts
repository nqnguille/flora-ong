...
export const WA_MESSAGES = {
  ...
  semilla: `Hola Flora, me interesa la membresía Semilla (10g/mes). ¿Cómo me asocio?`,
  raiz: `Hola Flora, me interesa la membresía Raíz (20g/mes). ¿Cómo me asocio?`,
  cosecha: `Hola Flora, me interesa la membresía Cosecha (40g/mes). ¿Cómo me asocio?`,
...
export const MEMBRESIAS = [
  ...
  },
  {
    ...
    acceso: '40g',
    unidad: 'por mes',
    descripcion: 'Máxima flexibilidad para quienes tienen un uso intensivo o quieren variedad de cepas.',
    badge: null,
    waMessage: WA_MESSAGES.cosecha,
    destacada: false,
  },
]
...
export const IMAGES = {
  hero: 'https://images.pexels.com/photos/1556706/pexels-photo-1556706.jpeg?auto=compress&cs=tinysrgb&w=1400',
