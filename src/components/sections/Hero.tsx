    ...
    >
      ...
      >
        <path
          ...
          strokeWidth="2"
        />
        <line x1="250" y1="40" x2="250" y2="650" stroke="#71CE6A" strokeWidth="1.5" strokeDasharray="8 6" />
        <path d="M250 180C200 180 120 210 70 340" stroke="#71CE6A" strokeWidth="1.5" />
        <path d="M250 180C300 180 380 210 430 340" stroke="#71CE6A" strokeWidth="1.5" />
        <path d="M250 310C195 290 125 315 75 420" stroke="#71CE6A" strokeWidth="1.5" />
        <path d="M250 310C305 290 375 315 425 420" stroke="#71CE6A" strokeWidth="1.5" />
        <path d="M250 430C200 410 135 445 100 530" stroke="#71CE6A" strokeWidth="1.5" />
        <path d="M250 430C300 410 365 445 400 530" stroke="#71CE6A" strokeWidth="1.5" />
        ...
        <div>
          ...
          <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={d(0)}>
            <span className="inline-flex items-center gap-2 bg-green-accent/15 border border-green-accent/30 text-green-accent section-tag px-4 py-1.5 rounded-full mb-8">
              ...
              Club de cultivo · Neuquén · Ley 27.350
            </span>
          </motion.div>
          ...
          >
            Ya elegiste el cannabis.
            <br />
            <em className="text-green-accent not-italic">
              Ahora elegí hacerlo bien.
            </em>
          </motion.h1>
          ...
          >
            Flora es un club de cultivo medicinal. Calidad verificada, genéticas
            seleccionadas y acceso legal. Sin incertidumbre, sin intermediarios
            dudosos, sin zona gris.
          </motion.p>
          ...
          >
            ...
            >
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-green-dark" aria-hidden="true">
